...
class InstallerController extends Controller
{
    ...
    {
        try {
            if (phpversion() >= '7.4' && OPENSSL_VERSION_NUMBER > 0x009080bf && extension_loaded('mbstring') && extension_loaded('tokenizer') && extension_loaded('xml') && extension_loaded('ctype')  && extension_loaded('json') && extension_loaded('bcmath') && extension_loaded('ctype') && extension_loaded('fileinfo')) {
                Session::put('step', 3);
                return redirect()->route('purchase_code_database');
            } else {
