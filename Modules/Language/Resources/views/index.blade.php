                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="add-new-page  bg-white p-20 m-b-20">
                            <div class="block-header">
                                <div>
                                    <span
                                        class="text-warning">{{ __('please_make_sure_you_have_set_writable_permision_following_folder') }}</span>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" value="{{ old('name') }}"
                                        class="form-control" placeholder="{{ __('language_name') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="code" name="code" type="text" value="{{ old('code') }}"
                                        class="form-control" placeholder="en" maxlength='5' minlength='2' required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="icon_class" class="form-control selectpicker text-uppercase" required>
                                        <option value=""> {{ __('select_option') }}</option>
                                        @foreach ($flagIcons as $icon)
                                        <option value="{{ $icon->icon_class }}" data-icon="{{ $icon->icon_class }}"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="regional" name="regional" type="text" value="{{ old('regional') }}"
                                        class="form-control" placeholder="en_GB">
                                </div>
                            </div>
                            ...
                            <div class="row p-l-15">
                                ...
                                <div class="col-3 col-md-2">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" name="text_direction" id="text_direction_left_to_right"
                                            value="LTR" class="custom-control-input" checked="checked">
                                        <span class="custom-control-label">{{ __('ltr') }}</span>
                                    </label>
                                </div>
                                <div class="col-3 col-md-2">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" name="text_direction" id="text_direction_right_to_left"
                    ...
                    <div class="col-12 col-lg-7">
                        <div class="add-new-page  bg-white p-20 m-b-20">
                            ...
                            <div class="table-responsive all-pages m-t-20">
                                <table class="table table-bordered table-striped dataTable no-footer" id="cs_datatable"
                                    role="grid" aria-describedby="cs_datatable_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th>{{ __('status') }}</th>
                                            @if(Sentinel::getUser()->hasAccess(['language_settings_write']) ||
                                            Sentinel::getUser()->hasAccess(['language_settings_delete']))
                                            <th>{{ __('options') }}</th>
                                            @endif
                                        </tr>
                                    </thead>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <li>
                                                            <a
                                                                href="{{ route('edit-language-info',['id'=>$lang->id]) }}"><i
                                                        ...
                                                        <li>
                                                            <a
                                                                href="{{ route('edit-default-messages',['id'=>$lang->id]) }}"><i
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="block-header">
                                        <h2>{{ __('showing')}} {{ $languages->firstItem()}} {{ __('to') }}
                                            {{ $languages->lastItem()}}
