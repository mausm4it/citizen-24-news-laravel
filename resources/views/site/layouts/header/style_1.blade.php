<header class="sg-header">
    ...
    <div class="sg-menu ">
        <nav style="background-color:#AB0012" class="navbar navbar-expand-lg">
            <div class="container">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item sg-dropdown">
                                <a href="{{menuUrl($mainMenu)}}"
                                    ...
                                    @if(!blank($mainMenu->children))<span><i class="fa fa-angle-down"
                                            aria-hidden="true"></i></span>@endif </a>
                                <ul class="sg-dropdown-menu">
                                    @foreach($mainMenu->children as $child)
                                    <li class=""><a href="{{menuUrl($child)}}"
                                            target="{{$child->new_teb == 1? '_blank':''}}">{{$child->label == 'gallery'? __('gallery'):$child->label}}
                                            @if(!blank($child->children)) <span class="pull-right"><i
                                                    class="fa fa-angle-right" aria-hidden="true"></i></span>@endif</a>
                                                                    ...
                                                                    <div class="entry-header">
                                                                        <div class="entry-thumbnail">
                                                                            <a
                                                                                ...
                                                                                @if(isFileExist(@$item->image, $result =
                                                                                @$item->image->medium_image_three))
                                                                                <img class="img-fluid"
